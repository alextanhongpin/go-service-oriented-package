...
// Inc provides a mock function with given fields: ctx, key
func (_m *Cache) Inc(ctx context.Context, key string) (int64, error) {
	ret := _m.Called(ctx, key)
...
func (_m *Cache) Set(ctx context.Context, key string, val string, ttl time.Duration) error {
...
func (_m *Cache) TTL(ctx context.Context, key string) (time.Duration, error) {
	ret := _m.Called(ctx, key)
